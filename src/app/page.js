        ...
        <section className="relative h-[90vh] w-full overflow-hidden">
          ...
          <div className="relative h-full flex flex-col justify-center items-center text-center px-6 md:px-12 pt-20">
            ...
            <div className="animate-fade-in-up animation-delay-300 text-white">
              <a
                href="#craft"
                className="inline-block border border-[#c9a227] text-white px-10 py-3 text-sm tracking-widest uppercase hover:bg-[#c9a227] hover:text-[#1a1a1a] transition-all duration-500"
              >
                Oppdag håndverket
              </a>
            </div>
        ...
        <section id="profile" className="py-32 bg-[#faf8f5]">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link
                href="/products"
                className="px-12 py-4 bg-[#1e3a5f] font-sans text-sm uppercase tracking-wider hover:bg-[#c9a227] hover:text-[#1a1a1a] transition-all duration-500"
                style={{ color: '#ffffff' }}
              >
              ...
              <Link
                href="/sellers"
                className="px-12 py-4 border border-[#1a1a1a] text-[#1a1a1a] font-sans text-sm uppercase tracking-wider hover:bg-[#1a1a1a] hover:text-[#f5f0e1] transition-all duration-500"
              >
                Møt Håndverkerne
              </Link>
            </div>
        ...
        <section id="about" className="py-32 bg-[#faf8f5]">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="font-sans text-lg text-[#333] leading-relaxed">
              Vi tror på industrialiseringens motsetning — håndverk som tar tid, materialer som modnes, og produkter som blir vakrere jo mer de brukes. Hver NORYA-piece er et løfte om kvalitet, et arvestykke i making.
            </p>
          </div>
        </section>
